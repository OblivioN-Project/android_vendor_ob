...
ALARM_PATH := vendor/ob/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/ob/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/ob/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/ob/prebuilt/common/media/audio/ui
